            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  ...
                  className="rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-[#1f2937] px-3 py-1.5 text-[11px] font-bold text-slate-600 dark:text-slate-300 transition hover:border-blue-200 hover:bg-blue-950/40 cursor-pointer"
                >
                  🩺 Doctor
                </button>
