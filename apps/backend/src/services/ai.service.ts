...
export class AiService {
  async suggestPrescription(diagnosis: string, symptoms?: string) {
    ...
    if (
      ...
      return {
        ...
        recommendedMedicines: [
          {
            ...
            duration: '3 Days',
            instruction: 'Take for fever > 100°F',
          },
          {
            name: 'Cetirizine 10mg',
            dosage: '0-0-1 (Night)',
            duration: '5 Days',
            instruction: 'For rhinitis / body ache',
          },
          {
        ...
        clinicalAdvice:
          'Hydration therapy (3L fluids/day), monitor temperature every 6 hours. Report if fever persists > 72 hours.',
        suggestedLabTests: [
          'Complete Blood Count (CBC)',
          'Dengue NS1 Antigen (if fever > 3 days)',
        ],
      };
    }
    ...
    if (
      ...
      return {
        ...
        clinicalAdvice:
          'Warm water gargles with salt, steam inhalation twice daily. Avoid chilled drinks.',
    ...
    if (
      ...
      return {
        ...
        recommendedMedicines: [
          {
            name: 'Rabeprazole 20mg + Domperidone 30mg',
            dosage: '1-0-0',
            duration: '7 Days',
            instruction: 'Empty stomach 30 mins before food',
          },
          {
            name: 'Sucralfate Syrup',
            dosage: '10ml BD',
            duration: '5 Days',
            instruction: '1 hour before meals',
          },
          {
            name: 'Dicyclomine 10mg (SOS)',
            dosage: 'As needed',
            duration: '3 Days',
            instruction: 'For abdominal spasm',
          },
        ],
        clinicalAdvice:
          'Bland diet, avoid spicy and fried items. Maintain 2-hour gap between dinner and sleeping.',
        suggestedLabTests: [
          'USG Whole Abdomen',
          'Serum Amylase & Lipase (if severe pain)',
        ],
      };
    }
        ...
        recommendedMedicines: [
          {
            ...
            duration: '30 Days',
            instruction: 'Monitor daily BP log',
          },
          {
            name: 'Amlodipine 5mg',
            dosage: '0-0-1 (If BP > 150/95)',
            duration: '15 Days',
            instruction: 'Adjunct if needed',
          },
        ],
        clinicalAdvice:
          'Low-salt diet (< 2g/day), 30 mins aerobic exercise. Maintain strict BP monitoring record.',
        suggestedLabTests: [
          'Serum Creatinine',
          'Lipid Profile',
          'ECG 12-Lead',
      ...
      recommendedMedicines: [
        {
          ...
          dosage: '0-1-0',
          duration: '10 Days',
          instruction: 'Post lunch',
        },
        {
          name: 'Paracetamol 500mg (SOS)',
          dosage: '1-0-0 (When needed)',
          duration: '3 Days',
          instruction: 'For pain or discomfort',
        },
      ],
      clinicalAdvice:
        'Adequate rest and fluid intake. Follow-up if symptoms persist after 3 days.',
  ...
  async generatePatientSummary(patientData: {
    ...
    const completedLabs = (patientData.labOrders || []).filter(
    ...
    const clinicalHighlights = [
      ...
      completedLabs.length
        ? `Diagnostic reports on file: ${completedLabs
            .map(
              (l: any) =>
                `${l.labTest?.testName || 'Test'}: ${l.resultValue || 'Done'}`,
            )
            .join(', ')}`
    ...
    return {
      ...
      clinicalHighlights,
      riskStratification:
        visitsCount > 4 ? 'MODERATE (Frequent Follow-ups)' : 'LOW / STABLE',
    };
  }
}
